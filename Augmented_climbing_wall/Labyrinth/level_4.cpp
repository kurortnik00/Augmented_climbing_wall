...
Level_4::Level_4()
	:blinkLine(sf::Vector2f(-30, Labyrinth::Game::GetWindow().getSize().y / 3 + 120), 0, 880),
	...
	line5(sf::Vector2f(blinkLine.size.x  + 200, Labyrinth::Game::GetWindow().getSize().y), 270, 210),
